#' Design matrix containing sentiment analysis variables and Amazon review classifications (training data)
#'
...
#' parts, X.train and y.train, it can be used along with a chosen value of
...
#' be used as the training dataset for LASSO regression. 
#' 
#' @docType data
#'
#' @format A matrix with 16699 rows and 33 variables:
#' \describe{
